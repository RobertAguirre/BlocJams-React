/* In a production environment, this data would likely come from a request to an API.
   For this project we will replicate the response of an API be declaring our data below.
------------------------------------------------------------------------------------------ */
export default [
  {
  title: 'The Colors',
